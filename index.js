...
if (media == 0) {
    ...
    console.log("Sua nota foi baixa: " + media);
}

else if (media >= 4 && media < 6) {
    console.log("Sua nota foi mediana: " + media);
}

else if (media >=7 && media < 9) {
    console.log("Sua nota final foi boa! " + media);
}

else if (media >= 9.1 && media < 9.9) {
    console.log("Sua nota foi ótima! " + media);
}

else if (media == 10) {
    console.log("Parabéns! Você fechou a prova!");
}
